          ...
          >
            ...
            <div className="hero-button flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center">
              <button
                ...
                className="border-2 border-white text-white px-6 py-2.5 sm:px-8 sm:py-3 md:px-10 md:py-4 rounded-lg font-semibold text-sm sm:text-base md:text-lg hover:bg-white hover:text-black transition-all duration-1000 hover:scale-105 flex items-center gap-3"
              >
                View Services
